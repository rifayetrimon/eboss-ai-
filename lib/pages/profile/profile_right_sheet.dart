...
class ProfileRightSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double navBarHeight = 70.0; // match your navigation bar height
        ...
        child: AnimatedSwitcher(
          ...
          child:
              controller.isOpen.value
                  ? Stack(
                    children: [
                      // Dimmed background (starts below nav bar)
                      Positioned(
                        top: navBarHeight,
                        left: 0,
                        right: 0,
                      ...
                      // Right sheet (starts just below nav bar, not full height, aligned to top)
                      Positioned(
                        top: navBarHeight,
                        right: 0,
                        width: sheetWidth,
